...
const Footer = () => {
  return (
          <div className="bg-gray-900 py-[61px] md:py-[120px] text-white ">
            <div className="container mx-auto rpx-5 md:px-0">
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6 text-center md:text-start ">
                    <div className="">
